...
<main class="login-form">
    <div class="cotainer" style="margin-top: 70px;">
        <div class="row justify-content-center">
            <div class="col-md-5">
                <div class="card">
                    <div class="card-header text-white" align="center" style="background-color: #ff5000;"><b><h4>Form Registrasi</h4></b></div>
                    <div class="card-body">
                      <?= $this->session->flashdata('pesan')?>
                        <form action="<?= base_url('registrasi')?>" method="post">
                            ...
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn text-white" style="background-color: #ff5000;">
                                    Daftar Akun
                                </button>
