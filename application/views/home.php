...
<body id="page-top">
      ...
      <div class="row">
        	<section class="bgwhite">
                ...
                <div class="container-right card bg-white mx-3 my-3" style="max-width: 12rem;">
                    ...
                    <img src="<?= base_url().'produk/'.$pro['gambar']?>" class="card-img-top" alt="...."></a>
                ...
                <?php if($pro['stok']=='0'){
                    ...
                    echo anchor('Home/tambah_ke_keranjang/'.$pro['kd_brg'],'<div class="btn text-white fas fa-shopping-cart" style="background-color: #ff5000;"> Beli</div>');
                  }
                ?>
  ...
  <section class="content-section bg-light text-white text-center" id="services">
    <div class="container">
      <div class="content-section-heading text-dark">
        Profil perusahaan
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <ul class="list-inline mb-5">
        <li class="list-inline-item">
          <a class="social-link rounded-circle text-white mr-3" style="background-color: #ff5000;" href="#!">
        ...
        <li class="list-inline-item">
          <a class="social-link rounded-circle text-white" style="background-color: #ff5000;" href="#!">
            <i class="fab fa-whatsapp"></i>
          </a>
        </li>
      </ul>
      <p class="text-muted small mb-0">Copyright &copy; <?= $judul;?> <?= date('Y')?></p>
    </div>
  </footer>
