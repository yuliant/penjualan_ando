...
<nav class="navbar navbar-light fixed-top" style="background-color: #ff5000;">
<!-- <nav class="navbar navbar-light fixed-top" style="background-color: transparent;"> -->
  ...
  <form action="" method="post" class="container-fluid" autocomplete="off">
    <a href="<?= base_url('')?>"><img src="<?= base_url('img/horeka1.png')?>" height="50"></a>
  ...
  <form action="" method="post" class="col-md-5 container">
      <tr>
        <td><div class="fa fa-home text-white">
            <a class="js-scroll-trigger text-light dua" href="<?= base_url('Home_admin')?>">Home</a></div>
        </td>
        <td><div class="fa fa-plus-square text-white">
            <a class="js-scroll-trigger text-light dua" href="<?= base_url('Home_admin/addbarang')?>">Add Barang</a></div>
        </td>
        <td><div class="fa fa-file text-white">
          <a class="js-scroll-trigger text-light dua" href="<?= base_url('invoice')?>">Invoice</a></div>
        </td>
        <td><div class="fa fa-user text-white">
          <a class="js-scroll-trigger text-light dua" href="<?= base_url('Home_admin/kelolahuser')?>">Hak Akses</a></div>
        </td>
        <td><div class="fa fa-file text-white">
          <a class="js-scroll-trigger text-light dua" href="<?= base_url('laporan')?>">Cetak Laporan</a></div>
        </td>
      </tr>
